...
def set_target_server_api(target_server: TargetServer) -> Response:
    ...
    return JSONResponse(content={"success": True, "code": 200, "msg": "200 OK",
                                 "data": {"current": {"host": target_server_host, "port": target_server_port}}},
                        status_code=200)
...
async def handle_exception(request: Request, exc: Exception) -> Response:
    if isinstance(exc, HTTPException):
        ...
        return JSONResponse(content={"success": False, "code": code, "msg": message, "data": None},
                            status_code=exc.status_code)
    else:
        message: str = "An unexpected error occurred."
        return JSONResponse(
            content={"success": False, "code": 500, "msg": message, "data": {"exception": traceback.format_exc()}},
            status_code=500)
